...
export function LoginExperience() {
  return (
    <main className="wf-login-page relative flex h-dvh items-center justify-center overflow-hidden px-[7vw] py-3 sm:px-[8vw]">
      <div className="auth-noise absolute inset-0" />
      <div className="wf-ambient wf-ambient-a" />

      <section className="unified-enter relative z-10 h-[min(720px,calc(100dvh-24px))] w-full max-w-[1020px] overflow-hidden rounded-[22px] border border-white/25 bg-transparent shadow-[0_20px_46px_rgba(7,47,33,0.28)]">
        <div className="grid h-full grid-cols-1 md:grid-cols-[60%_40%]">
          ...
          <aside className="order-1 h-full border-l border-white/35 bg-[#edf1f2]/95 px-8 py-7 md:order-2 md:px-10">
