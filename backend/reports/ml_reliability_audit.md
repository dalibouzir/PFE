...
- Classification model macro-F1: 0.4501

## Random Split (Secondary)
- Regression model MAE: 2.7763
- Classification model macro-F1: 0.4445

## Baseline Comparison (Time Split)
| Baseline | MAE | Delta vs model MAE | Model beats baseline |
| --- | ---: | ---: | :---: |
| stage_season_mean_loss | 3.7667 | -0.6068 | NO |
| product_stage_season_mean_loss | 3.7843 | -0.5892 | NO |
| stage_mean_loss | 3.8330 | -0.5405 | NO |
| product_stage_mean_loss | 3.8431 | -0.5304 | NO |
| product_stage_rolling_mean_loss | 4.0833 | -0.2902 | NO |
| product_mean_loss | 5.1248 | 0.7513 | YES |
| global_mean_loss | 5.1263 | 0.7528 | YES |
| previous_batch_loss_baseline | 5.4260 | 1.0525 | YES |

## Classification Baseline Comparison (Time Split)
| Candidate | Macro-F1 |
| --- | ---: |
| model | 0.4501 |
| thresholded_predicted_loss_baseline | 0.3554 |
...
- Classification decision: ml_model
- Anomaly decision: exploratory_only
- Recommendation decision: rule_engine_templates

## PFE Report Claims
Can claim:
- Classification ML outperforms threshold baselines by 21.05% on macro-F1 (time split).
