...
- Generated at: `2026-05-22T02:10:44.909141+00:00`
- Total cases: `25`
- PASS/PARTIAL/FAIL: `20/2/3`
...
|---|---|---|---|---|---|
| RQ06 | recommendations | ROUTING_ERROR | expected route HYBRID_FULL, got OUT_OF_SCOPE | OUT_OF_SCOPE | unsupported_hr_subjective |
...
| RQ06 | recommendations | FAIL | ROUTING_ERROR | HYBRID_FULL | OUT_OF_SCOPE | LOT_SPECIFIC_RECOMMENDATION | unsupported_hr_subjective |  | 0 | 0.40 |
...
| RQ13 | stocks | FAIL | COMPOSITION_QUALITY | SQL_ONLY | SQL_ONLY | factual_sql | factual_sql | get_low_stock_alerts | 0 | 0.78 |
...
| RQ15 | treasury | FAIL | COMPOSITION_QUALITY | SQL_ONLY | SQL_ONLY | factual_sql | factual_sql | get_treasury_traceability | 10 | 0.96 |
...
| RQ22 | memory | PARTIAL | EVIDENCE_INSUFFICIENT | SQL_ONLY | SQL_ONLY | factual_sql | FOLLOW_UP | clarification_required | 0 | 0.41 |
| RQ23 | memory | PARTIAL | EVIDENCE_INSUFFICIENT | SQL_ONLY | SQL_ONLY | factual_sql | FOLLOW_UP | clarification_required | 0 | 0.41 |
