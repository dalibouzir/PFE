...
- Generated at: `2026-05-21T16:02:58.263361+00:00`
- Total cases: `47`
- PASS/PARTIAL/FAIL: `41/4/2`
...
|---|---|---|---|---|---|
| FG03 | rag | ROUTING_ERROR | expected route RAG_ONLY, got HYBRID_SQL_RAG | HYBRID_SQL_RAG | hybrid_analysis |
| FD03 | dashboard | INTENT_MISMATCH | expected intent STOCK_CURRENT, got FACTUAL_SQL | SQL_ONLY | factual_sql |
...
| FD03 | dashboard | FAIL | INTENT_MISMATCH | SQL_ONLY | SQL_ONLY | STOCK_CURRENT | factual_sql | UNSUPPORTED_STOCKS_CAPABILITY | 0 | 0.31 |
...
| FR04 | recommendations | PASS | NO_FAILURE | HYBRID_FULL | HYBRID_FULL | RECOMMENDATION | RECOMMENDATION | get_canonical_material_balance | 2 | 0.43 |
...
| FG03 | rag | FAIL | ROUTING_ERROR | RAG_ONLY | HYBRID_SQL_RAG | BEST_PRACTICES | hybrid_analysis | get_process_step_losses | 1 | 0.41 |
