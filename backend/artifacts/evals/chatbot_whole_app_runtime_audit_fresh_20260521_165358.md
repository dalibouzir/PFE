...
- Generated at: `2026-05-21T15:53:58.406793+00:00`
- Total cases: `47`
- PASS/PARTIAL/FAIL: `39/4/4`
...
|---|---|---|---|---|---|
| FG03 | rag | ROUTING_ERROR | expected route RAG_ONLY, got SQL_ONLY | SQL_ONLY | STOCK_CURRENT |
| FR04 | recommendations | ROUTING_ERROR | expected route HYBRID_FULL, got SQL_ONLY | SQL_ONLY | LOSS_RANKING |
| FD01 | dashboard | ROUTING_ERROR | expected route SQL_ONLY, got OUT_OF_SCOPE | OUT_OF_SCOPE | unsupported |
| FO03 | commercial | ROUTING_ERROR | expected route SQL_ONLY, got OUT_OF_SCOPE | OUT_OF_SCOPE | unsupported |

## Full Results

| QID | Module | Status | Failure | Expected route | Actual route | Expected intent | Actual intent | SQL op | Evidence rows | Confidence |
|---|---|---|---|---|---|---|---|---|---:|---:|
| FD01 | dashboard | FAIL | ROUTING_ERROR | SQL_ONLY | OUT_OF_SCOPE | factual_sql | unsupported |  | 0 | 0.40 |
...
| FR01 | recommendations | PARTIAL | WARNING_NOISE | HYBRID_FULL | HYBRID_FULL | LOT_SPECIFIC_RECOMMENDATION | LOT_SPECIFIC_RECOMMENDATION | get_canonical_material_balance | 1 | 0.21 |
| FR02 | recommendations | PASS | NO_FAILURE | HYBRID_FULL | HYBRID_FULL | RECOMMENDATION | RECOMMENDATION | get_canonical_material_balance | 2 | 0.43 |
| FR03 | recommendations | PASS | NO_FAILURE | HYBRID_FULL | HYBRID_FULL | action_recommendation | action_recommendation | get_process_step_losses | 6 | 0.42 |
| FR04 | recommendations | FAIL | ROUTING_ERROR | HYBRID_FULL | SQL_ONLY | RECOMMENDATION | LOSS_RANKING | get_canonical_material_balance | 2 | 0.94 |
| FG01 | rag | PASS | NO_FAILURE | RAG_ONLY | RAG_ONLY | BEST_PRACTICES | BEST_PRACTICES |  | 0 | 0.12 |
| FG02 | rag | PASS | NO_FAILURE | RAG_ONLY | RAG_ONLY | BEST_PRACTICES | BEST_PRACTICES |  | 0 | 0.61 |
| FG03 | rag | FAIL | ROUTING_ERROR | RAG_ONLY | SQL_ONLY | BEST_PRACTICES | STOCK_CURRENT | get_current_stock | 4 | 0.94 |
...
| FO03 | commercial | FAIL | ROUTING_ERROR | SQL_ONLY | OUT_OF_SCOPE | factual_sql | unsupported |  | 0 | 0.40 |
| FO04 | commercial | PASS | NO_FAILURE | SQL_ONLY | SQL_ONLY | factual_sql | factual_sql | get_commercial_invoice_linkage | 4 | 0.94 |
| FF01 | invoices | PARTIAL | EVIDENCE_INSUFFICIENT | SQL_ONLY | SQL_ONLY | factual_sql | factual_sql | avg_paid_invoices_current_quarter | 0 | 0.24 |
...
| FML1 | ml | PARTIAL | EVIDENCE_INSUFFICIENT | ML_ONLY | ML_ONLY | risk_ml | risk_ml |  | 0 | 0.95 |
| FML2 | ml | PARTIAL | EVIDENCE_INSUFFICIENT | ML_ONLY | ML_ONLY | risk_ml | risk_ml |  | 0 | 0.32 |
