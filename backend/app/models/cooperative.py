...
class Cooperative(TimestampMixin, Base):
    ...
    parcels: Mapped[List["Parcel"]] = relationship(back_populates="cooperative", cascade="all, delete-orphan")
    pre_harvest_steps: Mapped[List["PreHarvestStep"]] = relationship(back_populates="cooperative", cascade="all, delete-orphan")
    global_charges: Mapped[List["GlobalCharge"]] = relationship(back_populates="cooperative", cascade="all, delete-orphan")
